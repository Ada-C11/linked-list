...
describe LinkedList do
  ...
  describe "has cycle" do
    it "can will return true if there is a cycle in the list" do
      # Arrange
      @list.add_first(2)
      @list.add_first(1)
  ...
  describe "Insert ascending" do
    it "Correctly places in the middle of a list" do
      # Arrange
      @list.add_first(5)
      @list.add_first(4)
      @list.add_first(2)
    ...
    it "Correctly places at start and end of a list" do
      # Arrange
      @list.add_first(5)
      @list.add_first(4)
      @list.add_first(2)
    ...
    it "Correctly places for an empty list" do
      # Act
      @list.insert_ascending(1)
